package com.bosonit.block10cors.persona.application;
...
import com.bosonit.block10cors.persona.controller.feign.PersonaFeign;
import com.bosonit.block10cors.persona.domain.Persona;
import com.bosonit.block10cors.exceptions.EntityNotFoundException;
import com.bosonit.block10cors.exceptions.UnprocessableEntityException;
...
public class PersonaServiceImpl implements PersonaService {
    ...
    public PersonaOutputDTO addPersona(PersonaInputDTO personaInputDTO) throws Exception {
        ...
        if (IPersonaRepository.existsByCompanyEmail(personaInputDTO.getCompany_email()))
