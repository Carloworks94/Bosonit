...
public class Block5SpringBootApplication implements CommandLineRunner {
    ...
    //APARTADO 1) Los mensajes muestran primero el bean1.saluda ya que está dentro del PostConstruct,
    //que lo que hace es inicializar esta función antes que el contexto de la aplicación.
