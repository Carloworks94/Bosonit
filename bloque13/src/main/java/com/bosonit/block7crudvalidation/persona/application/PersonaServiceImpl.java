...
public class PersonaServiceImpl implements PersonaService {
    ...
    public PersonaOutputDTO addPersona(PersonaInputDTO personaInputDTO) throws Exception {
        ...
        if (personaRepository.existsByCompanyEmail(personaInputDTO.getCompanyEmail()))
    ...
    public PersonaOutputDTO getPersona(int id) throws Exception {
        ...
        return persona.orElseThrow(() -> new EntityNotFoundException("Persona no encontrada")).personaToPersonaOutputDTO();//.orElseThrow(() -> new EntityNotFoundException("Persona no encontrada")).personaToPersonaOutputDTO();
    }
    ...
    public List<Persona> getPersonas(String user) {
        ...
        return personaRepository.findAllByUserPersona(user);
    }
...
//        return list;
    ...
    public PersonaOutputDTO deletePersona(int id) throws Exception {
        ...
        if (profesor != null || studentRepository.findByPersona(persona) != null)
